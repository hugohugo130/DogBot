...
目前的設定為：\`${text}\``);
                ...
                if (job_embed) {
                    ...
                    return await interaction.update({ embeds: [setEmbedFooter(client, embed)], components: [row] });
                }
                ...
                return await interaction.update({ embeds: [setEmbedFooter(client, embed)], components: [] });
            };
        } catch (err) {
