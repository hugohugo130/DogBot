...
Since <t:{1}:R>`,
            ...
            "channel.created_at": "Created At",
            "channel.description": "Descritpion",
            "channel.channel_info": "Channel Information",
            "channel.channel_type": "Type",
            "channel.channel_name": "Name",
            "channel.voice_channel": "Voice Channel",
            "channel.text_channel": "Text Channel",
            "channel.dm_channel": "DM Channel",
    ...
    [Locale.ChineseTW]: {
        ...
        "permissions": {
            ...
            "send_polls": "建立投票",
            "set_voice_channel_status": "設定語音頻道狀態",
...
結婚紀念日 <t:{1}:R>`,
            ...
            "channel.update": "更新",
            "channel.category": "類別",
            "channel.created_at": "創建於",
            "channel.description": "描述",
            "channel.channel_info": "頻道資訊",
            "channel.channel_type": "類型",
            "channel.channel_name": "名稱",
            "channel.voice_channel": "語音頻道",
            "channel.text_channel": "文字頻道",
            "channel.dm_channel": "私訊",
            "channel.position": "位置",
        },
        "/queue": {
...
export const PermissionTranslationKeyMapping = {
    ...
    SetVoiceChannelStatus: "set_voice_channel_status",
