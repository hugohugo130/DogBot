const { readJson, writeJson, existsSync, basename, join_db_folder, load_rpg_data, save_rpg_data } = require("./file.js");
 ...
 */
async function make_db_compatible(users) {
...
async function checkDBFilesDefault(client) {
    ...
    await make_db_compatible(users);
};
